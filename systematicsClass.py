...
class systematicsClass:
    ...
    def setSystematics(self,theRateBkg_qqZZ,theRateBkg_ggZZ,theRateBkg_zjets ):
        ...
        if not self.isForXSxBR:
            ...
            self.CSpdfErrPlus_gg = 1.0 #self.myCSW.HiggsCSpdfErrPlus(1,self.mH,self.sqrts)
            self.CSpdfErrMinus_gg = 1.0 #self.myCSW.HiggsCSpdfErrMinus(1,self.mH,self.sqrts)
            self.CSpdfErrPlus_vbf = 1.0 #self.myCSW.HiggsCSpdfErrPlus(2,self.mH,self.sqrts)
            self.CSpdfErrMinus_vbf = 1.0 #self.myCSW.HiggsCSpdfErrMinus(2,self.mH,self.sqrts)
            self.CSpdfErrPlus_wh = 1.0 #self.myCSW.HiggsCSpdfErrPlus(3,self.mH,self.sqrts)
            self.CSpdfErrMinus_wh = 1.0 #self.myCSW.HiggsCSpdfErrMinus(3,self.mH,self.sqrts)
            self.CSpdfErrPlus_zh = 1.0 #self.myCSW.HiggsCSpdfErrPlus(4,self.mH,self.sqrts)
            self.CSpdfErrMinus_zh = 1.0 #self.myCSW.HiggsCSpdfErrMinus(4,self.mH,self.sqrts)
            self.CSpdfErrPlus_tth = 1.0 #self.myCSW.HiggsCSpdfErrPlus(5,self.mH,self.sqrts)
            self.CSpdfErrMinus_tth = 1.0 #self.myCSW.HiggsCSpdfErrMinus(5,self.mH,self.sqrts)
            
            self.CSscaleErrPlus_gg = 1.0 #self.myCSW.HiggsCSscaleErrPlus(1,self.mH,self.sqrts)
            self.CSscaleErrMinus_gg = 1.0 #self.myCSW.HiggsCSscaleErrMinus(1,self.mH,self.sqrts)
            self.CSscaleErrPlus_vbf = 1.0 #self.myCSW.HiggsCSscaleErrPlus(2,self.mH,self.sqrts)
            self.CSscaleErrMinus_vbf = 1.0 #self.myCSW.HiggsCSscaleErrMinus(2,self.mH,self.sqrts)
            self.CSscaleErrPlus_wh = 1.0 #self.myCSW.HiggsCSscaleErrPlus(3,self.mH,self.sqrts)
            self.CSscaleErrMinus_wh = 1.0 #self.myCSW.HiggsCSscaleErrMinus(3,self.mH,self.sqrts)
            self.CSscaleErrPlus_zh = 1.0 #self.myCSW.HiggsCSscaleErrPlus(4,self.mH,self.sqrts)
            self.CSscaleErrMinus_zh = 1.0 #self.myCSW.HiggsCSscaleErrMinus(4,self.mH,self.sqrts)
            self.CSscaleErrPlus_tth = 1.0 #self.myCSW.HiggsCSscaleErrPlus(5,self.mH,self.sqrts)
            self.CSscaleErrMinus_tth = 1.0 #self.myCSW.HiggsCSscaleErrMinus(5,self.mH,self.sqrts)
      

            if( self.mH >= 200): self.theoryHighMass = 1 + 1.5*(self.mH/1000)*(self.mH/1000)*(self.mH/1000)
      
            self.BRErr_Hff = 1.0 #self.myCSWSM4.HiggsBRErr_Hff(11,self.mH,self.sqrts)
            self.BRErr_HVV = 1.0 #self.myCSWSM4.HiggsBRErr_HVV(11,self.mH,self.sqrts)
            self.BRErr_Hgg = 1.0 #self.myCSWSM4.HiggsBRErr_Hgluglu(11,self.mH,self.sqrts)
